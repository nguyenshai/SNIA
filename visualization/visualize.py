from visualization.scrollable import show_scrollable
"""
...
def visualize_all_categories(grid_problem, continuous_problem,
    ...
    fig.patch.set_facecolor(BG)
    fig.suptitle('Grand Algorithm Benchmark Tournament', color=TXT, fontsize=18, fontweight='bold', y=0.99)
